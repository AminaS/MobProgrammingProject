...
public class AlarmCreateActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mLoggerReceiverIntent = new Intent(AlarmCreateActivity.this, AlarmLoggerReceiver.class);


		mLoggerReceiverPendingIntent = PendingIntent.getBroadcast(AlarmCreateActivity.this, 0, mLoggerReceiverIntent, 0);


		final Button singleAlarmButton = (Button) findViewById(R.id.single_alarm_button);singleAlarmButton.setOnClickListener(new OnClickListener() {
			@Override
