...
public class NetworkingAndroidHttpClientActivity extends Activity {
	...
	protected static class HttpGetTask extends AsyncTask<Void, Void, String> {

		// Get your own user name at http://www.geonames.org/login
		private static final String USER_NAME = "aminasss";
		...
		protected void onPostExecute(String result) {
			...
			setListAdapter(new ArrayAdapter<String>(NetworkingAndroidHttpClientActivity.this, R.layout.list_view, reuslt));
		}
	}
}